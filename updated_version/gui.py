...
class WumpusWorldGUI:
    def __init__(self):
        ...
        # Use simple text symbols that work on all systems
        self.symbols = {
            '-': '',
            'A': 'A',
            'W': 'W',
    ...
    def setup_ui(self):
        ...
        left_frame = ttk.LabelFrame(game_frame, text="Current Game (Agent View)", padding=5)
        ...
        middle_frame = ttk.LabelFrame(game_frame, text="Original World (Reference)", padding=5)
        ...
        # Status
        self.status_label = ttk.Label(info_frame, text="Select a world to start", font=("Arial", 12, "bold"))
        ...
        for text, color in legend_items:
            ...
            color_box = tk.Label(frame, text="  ", bg=color, relief=tk.RAISED, width=3)
                ...
                if is_explored or cell_content == 'A':
                    ...
                    if symbol:
                        ...
                        self.canvas.create_text(x1 + self.cell_size//2, y1 + self.cell_size//2,
                                              text=symbol, font=("Arial", 14, "bold"), fill='black')
